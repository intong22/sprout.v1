<?php    
    ...
    {    
        ...
        if(isset($_POST["btnSend"]))
        {
            ...
            $insert = "INSERT INTO
                            plant_discussion(plant_id, account_id, message)
                        VALUES
        ...
        function discussion()
        {
            ...
            $get_details = "SELECT
                                ...
                                plant_discussion.message, plant_discussion.plant_id, plant_discussion.message_discussion_id
                            FROM
                                plant_discussion
                            INNER JOIN
                                user_account ON user_account.account_id = plant_discussion.account_id
                            WHERE
                                plant_id = ".$plant_id." ";
